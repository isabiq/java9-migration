...
DOCKER_IMAGE_TAG=1.0-java10-v2
...
echo '###############################################################'
echo "\$ sudo docker run --rm -t --name cqrs-java10-v2 cqrs:${DOCKER_IMAGE_TAG}"
echo '###############################################################'
sudo docker run --rm -t --name cqrs-java10-v2 cqrs:${DOCKER_IMAGE_TAG}
